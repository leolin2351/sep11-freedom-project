...
<h2>EDP:</h2>
<p>I am now on EDP of improve because now as i finished my mvp, i want to continue fixing and added things for my beyond mvp. Since we left off on creating the quiz now i want to add colors, text size, and formating my project. Its more of fun stuff rather than hard things because i finished the hard part now im on the easy part of my project. I mainly need to improve on using my creativity on this step.</p>
